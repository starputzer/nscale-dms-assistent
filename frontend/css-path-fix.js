...
(function () {
  ...
  const cssFiles = [
    {
      ...
      fallback: "/frontend/css/main.css",
      altFallback: "/public/css/main.css",
    },
    {
      original: "/css/themes.css",
      fallback: "/frontend/css/themes.css",
      altFallback: "/public/css/themes.css",
    },
    {
      original: "/css/improved-ui.css",
      fallback: "/frontend/css/improved-ui.css",
      altFallback: "/public/css/improved-ui.css",
    },
    {
      original: "/css/admin.css",
      fallback: "/frontend/css/admin.css",
      altFallback: "/public/css/admin.css",
    },
    {
      original: "/css/feedback.css",
      fallback: "/frontend/css/feedback.css",
      altFallback: "/public/css/feedback.css",
    },
    {
      original: "/css/message-actions.css",
      fallback: "/frontend/css/message-actions.css",
      altFallback: "/public/css/message-actions.css",
    },
    {
      original: "/css/settings.css",
      fallback: "/frontend/css/settings.css",
      altFallback: "/public/css/settings.css",
    },
    {
      original: "/css/source-references.css",
      fallback: "/frontend/css/source-references.css",
      altFallback: "/public/css/source-references.css",
    },
    {
      original: "/frontend/css/interaction-fix.css",
      fallback: "/css/interaction-fix.css",
      altFallback: "/public/css/interaction-fix.css",
    },
  ];
  ...
  function checkAndFixStylesheets() {
    ...
    const loadedSheets = Array.from(document.styleSheets).map(
      (sheet) => sheet.href,
    );
    ...
    const missingSheets = cssFiles.filter((css) => {
      ...
      const versionedAltFallback = new RegExp(
        css.altFallback + "(\\?v=\\w+)?$",
      );
      ...
      return !loadedSheets.some((href) => {
        ...
        return (
          versionedOriginal.test(href) ||
          versionedFallback.test(href) ||
          versionedAltFallback.test(href)
        );
      });
    });
