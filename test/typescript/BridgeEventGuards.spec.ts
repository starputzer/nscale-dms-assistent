...
describe('BridgeEventGuards TypeScript-Kompatibilität', () => {
  ...
  describe('Event-spezifische Type Guards', () => {
    it('sollte isBridgeInitializedEvent korrekt validieren', () => {
      ...
      expect(eventGuards.isBridgeInitializedEvent({
        ...validEvent,
    ...
    it('sollte isBridgeErrorEvent korrekt validieren', () => {
      ...
      expect(eventGuards.isBridgeErrorEvent({
        ...validEvent,
    ...
    it('sollte isBridgeStatusEvent korrekt validieren', () => {
      ...
      // Mit optionalen Feldern
      expect(eventGuards.isBridgeStatusEvent({
        ...validEvent,
    ...
    it('sollte isBridgeHealthCheckEvent korrekt validieren', () => {
      ...
      expect(eventGuards.isBridgeHealthCheckEvent({
        ...validEvent,
  ...
  describe('Legacy-Event Type Guards', () => {
    it('sollte isLegacySessionEvent korrekt validieren', () => {
      ...
      // Mit optionalen Feldern
      expect(eventGuards.isLegacySessionEvent({
        ...validEvent,
        metadata: {
    ...
    it('sollte isLegacyMessageEvent korrekt validieren', () => {
      ...
      // Mit anderen Rollen
      expect(eventGuards.isLegacyMessageEvent({
        ...validEvent,
        role: 'assistant'
      })).toBe(true);
      expect(eventGuards.isLegacyMessageEvent({
  ...
  describe('Vue-Command Type Guards', () => {
    it('sollte isVueSendMessageEvent korrekt validieren', () => {
      ...
      // Mit optionalen Feldern
      expect(eventGuards.isVueSendMessageEvent({
        ...validEvent,
        role: 'user'
      })).toBe(true);
  ...
  describe('Generische Type Guards', () => {
    it('sollte isBridgeEvent korrekt validieren', () => {
      ...
      expect(eventGuards.isBridgeEvent('bridge:initialized', initEvent)).toBe(true);
      ...
      expect(eventGuards.isBridgeEvent('vue:selectSession', sessionEvent)).toBe(true);
    ...
    it('sollte assertBridgeEvent korrekt validieren', () => {
      ...
      expect(() => eventGuards.assertBridgeEvent('bridge:initialized', initEvent)).not.toThrow();
      
      // Typsicherheit testen - der Rückgabewert sollte dem erwarteten Typ entsprechen
      const result = eventGuards.assertBridgeEvent('bridge:initialized', initEvent);
      type ResultAssert = AssertType<typeof result, BridgeInitializedEvent>;
      
      // Ungültiges Event
      expect(() => eventGuards.assertBridgeEvent('bridge:initialized', {})).toThrow();
    });
    ...
    it('sollte processTypedEvent korrekt verarbeiten', () => {
      ...
      // Verarbeitung testen
      const result = eventGuards.processTypedEvent('bridge:initialized', initEvent, handler);
      expect(result).toBe(true);
      expect(handler).toHaveBeenCalledWith(initEvent);
      
      // Ungültiges Event
      handler.mockClear();
      const invalidResult = eventGuards.processTypedEvent('bridge:initialized', {}, handler);
