...
import { deepDiff, applyDiff, DiffOperationType } from '@/bridge/enhanced/optimized/DeepDiff';
...
describe('OptimizedStateManager', () => {
  ...
  it('should respect immediate flag', () => {
    const processUpdatesSpy = vi.spyOn(stateManager as any, 'processPendingUpdates');
...
describe('MemoryManager', () => {
  ...
  it('should create auto-cleaning proxies', () => {
    ...
    const proxy = memoryManager.createAutoCleaningProxy(target, cleanup, 'test-proxy');
...
describe('OptimizedChatBridge', () => {
  ...
  it('should subscribe to state changes', () => {
    ...
    const unsubscribe = bridge.subscribeToState('messages', callback, component);
