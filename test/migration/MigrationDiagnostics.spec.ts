...
describe('MigrationDiagnostics', () => {
  ...
  it('should handle failed migration steps', () => {
    ...
    // Act
    migrationDiagnostics.reportProgress('comp1', 'step-1', false, { message: 'Test error' });
  ...
  it('should identify partially completed migrations', () => {
    ...
    migrationDiagnostics.reportProgress('comp1', 'step-1', true);
    migrationDiagnostics.reportProgress('comp1', 'step-2', true);
    migrationDiagnostics.reportProgress('comp1', 'step-3', false, { message: 'Test error' });
    
    // Assert
    const report = migrationDiagnostics.generateReport();
    expect(report.stateReports.comp1.status).toBe(MigrationStatus.PARTIALLY_COMPLETED);
  });
  ...
  it('should log deprecated API usage', () => {
    ...
    expect(report.warnings?.some(w => w.includes('Deprecated API'))).toBe(true);
  });
  ...
  it('should calculate overall migration status', () => {
    ...
    migrationDiagnostics.reportProgress('comp1', 'step-1', true);
    migrationDiagnostics.reportProgress('comp2', 'step-1', false, { message: 'Test error' });
  ...
  it('should generate recommended actions', () => {
    ...
    migrationDiagnostics.registerComponent('comp1', 'Component 1', 2);
    migrationDiagnostics.reportProgress('comp1', 'step-1', true);
    migrationDiagnostics.reportProgress('comp1', 'step-2', false, { message: 'Test error' });
    ...
    expect(report.recommendedActions?.some(a => a.includes('Review error logs'))).toBe(true);
  });
