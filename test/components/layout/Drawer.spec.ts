...
describe('Drawer.vue', () => {
  ...
  it('applies bordered header when headerBordered is true', async () => {
    ...
    const drawer = wrapper.findDrawer();
    expect(drawer!.find('.n-drawer__header').classes()).toContain('n-drawer__header--with-border');
  });
  ...
  it('applies bordered footer when footerBordered is true', async () => {
    ...
    const drawer = wrapper.findDrawer();
    expect(drawer!.find('.n-drawer__footer').classes()).toContain('n-drawer__footer--with-border');
  });
