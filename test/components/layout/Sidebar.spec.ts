...
describe("Sidebar.vue", () => {
  ...
  it("renders correctly with default props", () => {
    ...
    expect(wrapper.findAll(".n-sidebar__nav-item").length).toBe(
      defaultItems.length,
    );
  });
  ...
  it("renders favorited items correctly when showFavorites is true", async () => {
    ...
    expect(
      wrapper
        .findAll(".n-sidebar__nav-list")
        .at(1)
        .findAll(".n-sidebar__nav-item").length,
    ).toBe(2);
  });
  ...
  it("handles adding a favorite item", async () => {
    ...
    const addFavoriteButton = wrapper
      .findAll(".n-sidebar__nav-item")
      .at(1)
  ...
  it("handles removing a favorite item", async () => {
    ...
    const removeFavoriteButton = wrapper
      .findAll(".n-sidebar__nav-item--favorite")
      .at(0)
