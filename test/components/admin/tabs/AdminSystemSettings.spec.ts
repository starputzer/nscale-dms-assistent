...
describe('AdminSystemSettings.vue', () => {
  ...
  it('shows loading state while fetching settings', async () => {
    ...
    settingsStore.fetchSettings = vi.fn().mockImplementation(() => loadingPromise);
  ...
  it('handles errors when loading settings', async () => {
    ...
    expect(consoleErrorSpy).toHaveBeenCalledWith('Error loading settings:', testError);
  ...
  it('handles errors when saving settings', async () => {
    ...
    expect(wrapper.vm.isSubmitting).toBe(false);
    expect(consoleErrorSpy).toHaveBeenCalledWith('Error saving settings:', testError);
