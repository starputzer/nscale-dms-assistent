...
describe('DocumentPreview.vue', () => {
  ...
  it('sollte korrekt gerendert werden', async () => {
    ...
    expect(wrapper.find('.document-preview__file-name').text()).toBe(testDocument.originalName);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Textdateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__text-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für PDF-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__pdf-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Bilddateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__image-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für HTML-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__html-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Excel-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__table-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für PowerPoint-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__presentation-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Word-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__word-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Audio-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__audio-container').exists()).toBe(true);
  });
  ...
  it('sollte den korrekten Dokumenttyp für Video-Dateien erkennen', async () => {
    ...
    expect(wrapper.find('.document-preview__video-container').exists()).toBe(true);
  });
  ...
  it('sollte Syntax-Highlighting für Code-Dateien korrekt anwenden', async () => {
    const codeDocument = { ...testDocument, originalFormat: 'js', content: 'const test = "hello";' };
    const wrapper = mount(DocumentPreview, {
      props: {
    ...
    expect(wrapper.find('.document-preview__text-container').exists()).toBe(true);
    expect(wrapper.find('.document-preview__highlighted-text').exists()).toBe(true);
  });
  ...
  it('sollte die Metadaten korrekt anzeigen', async () => {
    ...
    const showMetadataButton = wrapper.find('[data-testid="show-metadata-btn"]');
    await showMetadataButton.trigger('click');

    // Prüfen, ob die Metadaten angezeigt werden
    expect(wrapper.find('.document-preview__metadata-content').exists()).toBe(true);
