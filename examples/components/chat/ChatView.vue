<template>
  <div class="chat-container h-full">
    ...
    <MotdDisplay
      v-if="
        motdStore.motd &&
        motdStore.motd.enabled &&
        motdStore.motd.display.showInChat &&
        !motdStore.isDismissed
      "
      :motd="motdStore.motd"
      class="mb-4"
    ...
    <div
      ...
      class="flex h-full items-center justify-center text-gray-400 p-8"
    >
      <div class="text-center">
        ...
        <p class="text-sm text-gray-500 mb-4">
          Wählen Sie eine Unterhaltung aus der Seitenleiste oder starten Sie
          eine neue.
        </p>
