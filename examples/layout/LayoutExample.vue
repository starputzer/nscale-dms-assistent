      ...
      >
        <template #logo>
          <div class="example-logo">
            ...
            >
              <path
                d="M21 8v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h14a2 2 0 012 2z"
              ></path>
    ...
    <div class="example-content">
      ...
      <div v-if="currentPage.id === 'dashboard'" class="example-dashboard">
        <div class="example-card">
          ...
          <p>
            Dieses Beispiel demonstriert die Verwendung der Layout-Komponenten:
          </p>
          <ul>
            <li>
  ...
  setup() {
    ...
    <template #footer>
      <div class="example-footer">
        <p>
          © 2025 nscale DMS Assistent | <a href="#">Impressum</a> |
...
const sidebarItems = computed<SidebarItem[]>(() => {
  return pages.map((page) => ({
    ...
    active:
      ...
      (page.children?.some((child) => child.id === currentPageId.value) ??
        false),
...
const currentPage = computed(() => {
  ...
  for (const parentPage of pages) {
    if (parentPage.children) {
      const childPage = parentPage.children.find(
        (child) => child.id === currentPageId.value,
      );
