 ...
 * 
 * Verwendung:
 * node legacy-code-deactivation.js --action=checkStatus
 * node legacy-code-deactivation.js --action=deactivate --component=UI
 * node legacy-code-deactivation.js --action=deactivate --component=all
 * node legacy-code-deactivation.js --action=rollback
 */
...
Verwendung:
  node legacy-code-deactivation.js --action=checkStatus
  node legacy-code-deactivation.js --action=deactivate --component=ui
  node legacy-code-deactivation.js --action=deactivate --component=functional
  node legacy-code-deactivation.js --action=deactivate --component=utility
  node legacy-code-deactivation.js --action=deactivate --component=core
  node legacy-code-deactivation.js --action=deactivate --component=all
  node legacy-code-deactivation.js --action=rollback
