...
(function() {
  ...
  if (!window.nScaleBridge) {
    console.warn('Bridge ist nicht verfügbar. Stelle sicher, dass sie vor diesem Skript geladen wird.');
    return;
  }
  ...
  const ChatBridgeIntegration = {
    ...
    registerEventHandlers: function() {
      ...
      this.bridge.on('vueChat:messagesUpdated', this.handleMessagesUpdated.bind(this));
      this.bridge.on('vueChat:statusUpdated', this.handleStatusUpdated.bind(this));
      this.bridge.on('vueChat:sessionsUpdated', this.handleSessionsUpdated.bind(this));
      this.bridge.on('vueChat:sessionCreated', this.handleSessionCreated.bind(this));
      this.bridge.on('vueChat:sessionDeleted', this.handleSessionDeleted.bind(this));
      ...
      this.bridge.on('vanillaChat:requestSync', this.handleSyncRequest.bind(this));
    },
