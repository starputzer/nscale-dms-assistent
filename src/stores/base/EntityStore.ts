 ...
 */
export interface EntityStoreOptions<T extends Entity> extends BaseStoreOptions<EntityStoreState<T>> {
  /**
 ...
 */
export type EntityStoreReturn<T extends Entity> = BaseStoreReturn<EntityStoreState<T>> & {
  // Entitäten-Collections
  entities: Map<string, T>;
  selectedIds: Set<string>;
  currentEntityId: string | null;
