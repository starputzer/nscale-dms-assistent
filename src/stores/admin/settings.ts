...
export const useAdminSettingsStore = defineStore('adminSettings', () => {
  ...
  const defaultSettings: SystemSettings = {
    ...
    maintenanceMessage: 'Das System wird aktuell gewartet. Bitte versuchen Sie es später erneut.',
  ...
  async function toggleMaintenanceMode(activate: boolean, message?: string) {
    ...
    try {
      ...
      settings.value.maintenanceMessage = originalSettings.value.maintenanceMessage;
