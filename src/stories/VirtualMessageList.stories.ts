...
const mockMessages = [
  ...
  },
  {
    id: "5",
    content:
      "Die Indexierung von Dokumenten in nscale DMS erfolgt über den Indexierungsdienst. Du kannst dies über die Verwaltungsoberfläche konfigurieren oder automatische Indexierung einrichten. Möchtest du dazu mehr Details erfahren?",
    role: "assistant",
...
const longMessageList = Array.from({ length: 50 }, (_, i) => ({
  ...
  timestamp: new Date(
    new Date().getTime() - (3100000 - i * 10000),
  ).toISOString(),
  sessionId: "session-1",
  status: "sent",
}));
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Eine virtualisierte Chat-Nachrichtenliste mit optimierter Performance für große Nachrichtenverläufe.",
      },
    },
  },
  ...
  args: {
    messages: [
      ...mockMessages,
      {
        id: "streaming",
        content:
          "Ich bereite weitere Informationen zur Indexierung von Dokumenten vor...",
        role: "assistant",
