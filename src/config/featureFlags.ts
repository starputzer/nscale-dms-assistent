 ...
 */
export function isFeatureEnabled(feature: keyof typeof FEATURE_FLAGS | string): boolean {
...
export function initializeFeatureFlags(): string[] {
  ...
  try {
    ...
    console.warn('Fehler beim Laden der Feature-Flags aus dem LocalStorage:', error);
  }
