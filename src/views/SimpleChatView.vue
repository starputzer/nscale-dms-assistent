    ...
    <div class="message-area" ref="messageArea">
      ...
      <div v-else class="messages">
        <div 
          ...
          :key="message.id"
          class="message"
          :class="{ 'message-user': message.role === 'user', 'message-assistant': message.role !== 'user' }"
        >
          ...
          <div class="message-content">
            <div class="message-header">
              <span class="message-sender">{{ message.role === 'user' ? 'Sie' : 'Assistent' }}</span>
            ...
            <div v-if="message.role !== 'user'" class="message-actions">
              <button class="action-btn" @click="handleFeedback(message, 'positive', $event)">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path>
                </svg>
              </button>
              <button class="action-btn" @click="handleFeedback(message, 'negative', $event)">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
const handleFeedback = async (message: any, type: 'positive' | 'negative', event?: Event) => {
