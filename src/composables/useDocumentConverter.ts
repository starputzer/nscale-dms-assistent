...
import { ConversionResult, ConversionSettings } from '@/types/documentConverter';
...
export function useDocumentConverter() {
  ...
  async function initialize(): Promise<void> {
    ...
    try {
      ...
      error.value = err instanceof Error ? err : new Error('Fehler beim Laden der Dokumente');
  ...
  async function uploadDocument(file: File): Promise<string | null> {
    ...
    try {
      ...
      const documentId = await DocumentConverterService.uploadDocument(file, (progress) => {
      ...
      error.value = err instanceof Error ? err : new Error('Fehler beim Hochladen des Dokuments');
  ...
  async function convertDocument(
    ...
    try {
      ...
      error.value = err instanceof Error ? err : new Error('Fehler bei der Konvertierung des Dokuments');
  ...
  async function deleteDocument(documentId: string): Promise<boolean> {
    ...
    try {
      ...
      error.value = err instanceof Error ? err : new Error('Fehler beim Löschen des Dokuments');
