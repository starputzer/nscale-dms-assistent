...
export class AdminService {
  ...
  public async getSystemInfo(): Promise<ApiResponse<SystemInfo>> {
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der Systeminformationen',
        error: {
  ...
  public async getApiUsageStats(): Promise<ApiResponse<ApiUsageStats>> {
    try {
      ...
      this.logger.error('Fehler beim Abrufen der API-Nutzungsstatistiken', error);
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der API-Nutzungsstatistiken',
        error: {
  ...
  public async getAnnouncements(): Promise<ApiResponse<Announcement[]>> {
    try {
      return await apiService.get<Announcement[]>(
        '/admin/announcements'
      );
    } catch (error) {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der Ankündigungen',
        error: {
   ...
   */
  public async saveAnnouncement(announcement: Announcement): Promise<ApiResponse<Announcement>> {
    try {
      // Prüfen, ob Admin-Rechte vorhanden sind
      if (!this.hasAdminAccess()) {
        return {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Speichern der Ankündigung',
        error: {
  ...
  public async deleteAnnouncement(id: string): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim Löschen der Ankündigung ${id}`,
        error: {
  ...
  public async getUsers(
    ...
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der Benutzerliste',
        error: {
  ...
  public async createUser(user: Partial<User>): Promise<ApiResponse<User>> {
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Erstellen des Benutzers',
        error: {
  ...
  public async updateUser(userId: string, updates: Partial<User>): Promise<ApiResponse<User>> {
    try {
      ...
      this.logger.error(`Fehler beim Aktualisieren des Benutzers ${userId}`, error);
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim Aktualisieren des Benutzers ${userId}`,
        error: {
  ...
  public async deleteUser(userId: string): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim Löschen des Benutzers ${userId}`,
        error: {
   ...
   */
  public async toggleUserLock(userId: string, locked: boolean): Promise<ApiResponse<User>> {
    try {
      // Prüfen, ob Admin-Rechte vorhanden sind
      if (!this.hasAdminAccess()) {
        return {
      ...
      this.logger.error(`Fehler beim ${locked ? 'Sperren' : 'Entsperren'} des Benutzers ${userId}`, error);
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim ${locked ? 'Sperren' : 'Entsperren'} des Benutzers ${userId}`,
        error: {
   ...
   */
  public async getFeatureFlags(): Promise<ApiResponse<Record<string, boolean>>> {
    try {
      return await apiService.get<Record<string, boolean>>(
        '/admin/features'
      );
    } catch (error) {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der Feature-Flags',
        error: {
   ...
   */
  public async updateFeatureFlag(featureKey: string, enabled: boolean): Promise<ApiResponse<void>> {
    try {
      // Prüfen, ob Admin-Rechte vorhanden sind
      if (!this.hasAdminAccess()) {
        return {
      ...
      this.logger.error(`Fehler beim Aktualisieren des Feature-Flags ${featureKey}`, error);
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim Aktualisieren des Feature-Flags ${featureKey}`,
        error: {
  ...
  public async getSystemLogs(
    ...
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen der Systemprotokolle',
        error: {
  ...
  public async getSystemSettings(): Promise<ApiResponse<Record<string, any>>> {
    try {
      ...
      return await apiService.get<Record<string, any>>(
        '/admin/settings'
      );
    } catch (error) {
   ...
   */
  public async updateSystemSettings(settings: Record<string, any>): Promise<ApiResponse<Record<string, any>>> {
    try {
      // Prüfen, ob Admin-Rechte vorhanden sind
      if (!this.hasAdminAccess()) {
        return {
      ...
      this.logger.error('Fehler beim Aktualisieren der Systemeinstellungen', error);
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Aktualisieren der Systemeinstellungen',
        error: {
  ...
  public async getFeedback(
    ...
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler beim Abrufen des Feedbacks',
        error: {
   ...
   */
  public async updateFeedbackStatus(feedbackId: string, resolved: boolean): Promise<ApiResponse<Feedback>> {
    try {
      // Prüfen, ob Admin-Rechte vorhanden sind
      if (!this.hasAdminAccess()) {
        return {
      ...
      return await apiService.patch<Feedback>(
        `/admin/feedback/${feedbackId}`,
        { resolved }
      );
    } catch (error) {
      this.logger.error(`Fehler beim Aktualisieren des Feedback-Status ${feedbackId}`, error);
      return {
        success: false,
        message: error instanceof Error ? error.message : `Fehler beim Aktualisieren des Feedback-Status ${feedbackId}`,
        error: {
  ...
  public async invalidateCache(cacheKey?: string): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Fehler bei der Cache-Invalidierung',
        error: {
