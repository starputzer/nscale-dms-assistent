...
export class AdminServiceWrapper {
  ...
  async createUser(userData: NewUser): Promise<User> {
    try {
      this.logService.debug('Erstelle neuen Benutzer', { email: userData.email, role: userData.role });
      const response = await adminApi.createUser(userData);
      return response.data.user;
    } catch (error) {
      this.logService.error('Fehler beim Erstellen eines Benutzers', { ...error, userData });
  ...
  async updateUserRole(userId: string, role: string): Promise<User> {
    try {
      ...
      this.logService.error('Fehler beim Aktualisieren der Benutzerrolle', { ...error, userId, role });
      throw this.formatError(error, 'Benutzerrolle konnte nicht aktualisiert werden');
    }
  }
  ...
  async deleteUser(userId: string): Promise<void> {
    try {
      ...
      this.logService.error('Fehler beim Löschen eines Benutzers', { ...error, userId });
  ...
  async getSystemStats(): Promise<SystemStats> {
    try {
      ...
      throw this.formatError(error, 'Systemstatistiken konnten nicht geladen werden');
    }
  }

  async performSystemAction(action: SystemAction): Promise<void> {
    try {
      this.logService.debug('Führe Systemaktion aus', { actionType: action.type });
      ...
      this.logService.error('Fehler beim Ausführen einer Systemaktion', { ...error, actionType: action.type });
      throw this.formatError(error, `Die Aktion '${action.name}' konnte nicht ausgeführt werden`);
    }
  }
  ...
  async getFeedbackStats(): Promise<FeedbackStats> {
    try {
      ...
      this.logService.error('Fehler beim Abrufen der Feedback-Statistiken', error);
      throw this.formatError(error, 'Feedback-Statistiken konnten nicht geladen werden');
    }
  }
  ...
  async getNegativeFeedback(filter?: FeedbackFilter): Promise<FeedbackEntry[]> {
    try {
      ...
      if (filter) {
        if (filter.dateFrom) {
          feedback = feedback.filter(entry => entry.created_at >= filter.dateFrom!);
        }
        if (filter.dateTo) {
          feedback = feedback.filter(entry => entry.created_at <= filter.dateTo!);
        }
        if (filter.isPositive !== undefined) {
          feedback = feedback.filter(entry => entry.is_positive === filter.isPositive);
        }
      ...
      this.logService.error('Fehler beim Abrufen des negativen Feedbacks', { ...error, filter });
      throw this.formatError(error, 'Negatives Feedback konnte nicht geladen werden');
    }
  }
  ...
  async getMotd(): Promise<MotdConfig> {
    try {
      ...
      this.logService.error('Fehler beim Abrufen der MOTD-Konfiguration', error);
      throw this.formatError(error, 'MOTD-Konfiguration konnte nicht geladen werden');
    }
  }
  ...
  async updateMotd(motdConfig: MotdConfig): Promise<MotdConfig> {
    try {
      ...
      this.logService.error('Fehler beim Aktualisieren der MOTD-Konfiguration', { ...error, motdConfig });
      throw this.formatError(error, 'MOTD-Konfiguration konnte nicht aktualisiert werden');
    }
  }
  ...
  async getDocConverterStatus(): Promise<DocConverterStatus> {
    try {
      ...
      this.logService.error('Fehler beim Abrufen des Dokumentenkonverter-Status', error);
      throw this.formatError(error, 'Dokumentenkonverter-Status konnte nicht geladen werden');
    }
  }
  ...
  async getDocConverterJobs(): Promise<DocConverterJob[]> {
    try {
      ...
      this.logService.error('Fehler beim Abrufen der Dokumentenkonverter-Jobs', error);
      throw this.formatError(error, 'Dokumentenkonverter-Jobs konnten nicht geladen werden');
    }
  }
  ...
  async getDocConverterSettings(): Promise<DocConverterSettings> {
    try {
      ...
      this.logService.error('Fehler beim Abrufen der Dokumentenkonverter-Einstellungen', error);
      throw this.formatError(error, 'Dokumentenkonverter-Einstellungen konnten nicht geladen werden');
    }
  }

  async updateDocConverterSettings(settings: DocConverterSettings): Promise<DocConverterSettings> {
    try {
      ...
      this.logService.error('Fehler beim Aktualisieren der Dokumentenkonverter-Einstellungen', { ...error, settings });
      throw this.formatError(error, 'Dokumentenkonverter-Einstellungen konnten nicht aktualisiert werden');
    }
  }
  ...
  async startDocConverterJob(jobId: string): Promise<void> {
    try {
      ...
      this.logService.error('Fehler beim Starten eines Dokumentenkonverter-Jobs', { ...error, jobId });
      throw this.formatError(error, 'Dokumentenkonverter-Job konnte nicht gestartet werden');
    }
  }
  ...
  async cancelDocConverterJob(jobId: string): Promise<void> {
    try {
      ...
      this.logService.error('Fehler beim Abbrechen eines Dokumentenkonverter-Jobs', { ...error, jobId });
      throw this.formatError(error, 'Dokumentenkonverter-Job konnte nicht abgebrochen werden');
    }
  }
  ...
  async getLogs(params?: {
    ...
    try {
      ...
      this.logService.error('Fehler beim Abrufen der Logs', { ...error, params });
