...
export class ServiceAdapterFactory {
   ...
   */
  public static createSessionServiceAdapter(
    originalService: any = sessionService,
  ): SessionServiceInterface {
   ...
   */
  public static createStreamingServiceAdapter(
...
export const typedSessionService =
  ServiceAdapterFactory.createSessionServiceAdapter();
