...
export class RetryHandler {
  ...
  constructor(options: RetryHandlerOptions = {}) {
    ...
    this.backoffFactor = options.backoffFactor ?? apiConfig.RETRY.BACKOFF_FACTOR;
    this.retryStatusCodes = options.retryStatusCodes ?? apiConfig.RETRY.RETRY_STATUS_CODES;
    this.retryNetworkErrors = options.retryNetworkErrors ?? apiConfig.RETRY.RETRY_NETWORK_ERRORS;
