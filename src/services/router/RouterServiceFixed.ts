...
export class RouterService {
  ...
  // Computed properties
  public readonly isInitialized = computed(() => this.state.value.isInitialized);
  public readonly isNavigating = computed(() => this.state.value.isNavigating);
  public readonly currentRoute = computed(() => this.router?.currentRoute.value);
  ...
  public async navigate(
    ...
    while (retries <= maxRetries) {
      try {
        ...
        console.warn(`[RouterService] Navigation failed (attempt ${retries + 1}):`, error);
