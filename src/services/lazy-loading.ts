...
const componentRegistry = {
  ...
  'AdminSettings': () => import('@/components/admin/tabs/AdminSystemSettings.vue'),
  ...
  // Document Converter
  'DocumentConverter': () => import('@/components/admin/document-converter/DocConverterContainer.vue'),
  'FallbackConverter': () => import('@/components/admin/document-converter/FallbackConverter.vue'),
  'ConverterStats': () => import('@/components/admin/document-converter/ConversionStats.vue'),
  
  // Chat Komponenten
  'EnhancedChat': () => import('@/components/chat/EnhancedChatContainer.vue'),
  'MessageComposer': () => import('@/components/chat/enhanced/EnhancedMessageInput.vue'),
  ...
  'VirtualScroller': () => import('@/components/chat/enhanced/VirtualMessageList.vue'),
 ...
 */
export function registerComponent(name: string, loader: () => Promise<any>): void {
