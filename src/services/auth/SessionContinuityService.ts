...
export class SessionContinuityService {
  ...
  public async initializeSession(): Promise<RestorationResult> {
    ...
    this.restorationPromise = this.performRestoration().finally(() => {
  ...
  private async performRestoration(): Promise<RestorationResult> {
    try {
      ...
      console.log(
        "[SessionContinuity] Starte Wiederherstellungsversuch",
        this.state.restorationAttempts,
      );
      ...
      console.log(
        "[SessionContinuity] Gültige Token gefunden, Wiederherstellung erfolgreich",
      );
      ...
      console.error(
        "[SessionContinuity] Fehler bei der Wiederherstellung:",
        error,
      );
