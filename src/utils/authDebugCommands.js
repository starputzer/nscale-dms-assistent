...
window.authDebug = {
  ...
  diagnose: () => {
    ...
    // Check interceptors
    console.log('\n=== Axios Interceptors ===');
    console.log('Request interceptors:', window.axios.interceptors.request.handlers.length);
    console.log('Response interceptors:', window.axios.interceptors.response.handlers.length);
