...
export type AuthRouteNames = 'Login' | 'Register' | 'ForgotPassword' | 'ResetPassword'
...
export const authRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: {
      ...
      description: 'Melden Sie sich bei nscale DMS Assistent an oder erstellen Sie ein neues Konto.'
    }
  },
  {
    path: '/register',
  ...
  router.onError((error: any) => {
    ...
    if (
      ...
      router.push({ 
        ...
        query: { 
          error: 'auth_error',
          message: 'Ein Fehler ist bei der Anmeldung aufgetreten. Bitte versuchen Sie es erneut.'
        } 
      })
    }
  })
