  ...
  >
    ...
    <div class="n-pagination-controls">
      ...
      >
        ...
        <span v-if="!hideLabels" class="n-pagination-button-text">{{ prevText }}</span>
      </button>
      ...
      <button
        ...
        type="button"
      >
        <span v-if="!hideLabels" class="n-pagination-button-text">{{ nextText }}</span>
        <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">
    ...
    <div v-if="pageSizeOptions.length > 0 && !simple" class="n-pagination-size">
      <label :id="id + '-pagesize-label'" class="n-pagination-size-label">{{ perPageText }}</label>
      <select
...
.n-pagination-page:hover:not(.n-pagination-page--active):not(.n-pagination-page--ellipsis):not(:disabled) {
  background-color: var(--nscale-gray-100);
  border-color: var(--nscale-gray-400);
}
...
.theme-dark .n-pagination-page:hover:not(.n-pagination-page--active):not(.n-pagination-page--ellipsis):not(:disabled) {
...
.theme-contrast .n-pagination-page:hover:not(.n-pagination-page--active):not(.n-pagination-page--ellipsis):not(:disabled) {
