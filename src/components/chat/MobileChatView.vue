<template>
  <div
    class="mobile-chat-view"
    :class="{ 'mobile-chat-view--dark': isDarkMode }"
  >
    <!-- Mobile Header mit Sessionwechsel und Menü -->
    <div class="mobile-chat-view__header">
      <button
        class="mobile-chat-view__menu-btn touch-target touch-ripple"
      ...
      <button
        class="mobile-chat-view__action-btn touch-target touch-ripple"
        @click="openSettings"
    ...
    <div
      ...
      :class="{
        'mobile-chat-view__session-sidebar--visible': showSessionSidebar,
      }"
    >
      <div class="mobile-chat-view__sidebar-header">
        <h2 class="mobile-chat-view__sidebar-title">Unterhaltungen</h2>
        <button
          class="mobile-chat-view__close-btn touch-target touch-ripple"
          @click="toggleSessionSidebar"
      ...
      <div class="mobile-chat-view__sidebar-content">
        <button
          class="mobile-chat-view__new-session-btn touch-target touch-feedback"
        ...
        <div class="mobile-chat-view__session-list">
          <div
            ...
            :key="session.id"
            class="mobile-chat-view__session-item touch-feedback"
            :class="{
              'mobile-chat-view__session-item--active':
          ...
          >
            <div class="mobile-chat-view__session-info">
              <div class="mobile-chat-view__session-title">
                {{ session.title }}
              </div>
              <div class="mobile-chat-view__session-date">
            ...
            >
              <button
                class="mobile-chat-view__session-action mobile-chat-view__session-action--rename touch-target"
              ...
              <button
                class="mobile-chat-view__session-action mobile-chat-view__session-action--delete touch-target"
              ...
              <button
                class="mobile-chat-view__session-action mobile-chat-view__session-action--close touch-target"
    ...
    <!-- Chat Messages Area -->
    <div
      class="mobile-chat-view__messages custom-scrollbar"
    ...
    >
      <div v-if="!hasMessages" class="mobile-chat-view__empty-state">
        ...
        <h3 class="mobile-chat-view__empty-title">
          Starten Sie eine neue Unterhaltung
        </h3>
        <p class="mobile-chat-view__empty-text">
    ...
    <div class="mobile-chat-view__input-area">
      ...
      <div class="mobile-chat-view__input-container">
        ...
        <button
          class="mobile-chat-view__send-btn touch-target touch-ripple"
...
const currentMessages = computed(() => {
  return currentSessionId.value
    ? allMessages.value[currentSessionId.value] || []
    : [];
});
...
.mobile-chat-view {
  ...
  &__send-btn {
    ...
    border-radius: calc(var(--touch-target-min, 44px) / 2);
    border: none;
    background-color: var(--nscale-primary);
    color: white;
    align-self: flex-end;
