...
describe("MessageInput", () => {
  ...
  describe("Rendering", () => {
    ...
    it("shows streaming status when streaming", () => {
      ...
      expect(wrapper.find(".n-chat-input__streaming-status").exists()).toBe(
        true,
      );
      expect(wrapper.find(".n-chat-input__streaming-text").text()).toBe(
    ...
    it("shows editing status when editing", () => {
      ...
      expect(wrapper.find(".n-chat-input__editing-text").text()).toBe(
  ...
  describe("Template handling", () => {
    ...
    it("applies template on click", async () => {
      const templates = [{ label: "Hello", content: "Hello, how can I help?" }];
  ...
  describe("Error and hint display", () => {
    ...
    it("displays hint message", () => {
      ...
      expect(wrapper.find(".n-chat-input__hint").text()).toBe(
        "Press Enter to send",
      );
    });
  });
