    ...
    <section class="test-section">
      ...
      <div class="contrast-grid">
        <div class="contrast-item">
          <div class="contrast-sample" :style="{ background: 'var(--nscale-bg-primary)', color: 'var(--nscale-text-primary)' }">
            <h3>Primary Text on Background</h3>
            <p>This text should be clearly readable with a contrast ratio of at least 4.5:1</p>
            <small>Small text requires 4.5:1 contrast ratio (WCAG AA)</small>
          </div>
        </div>
        
        <div class="contrast-item">
          <div class="contrast-sample" :style="{ background: 'var(--nscale-bg-surface)', color: 'var(--nscale-text-secondary)' }">
        ...
        <div class="contrast-item">
          <div class="contrast-sample" :style="{ background: 'var(--nscale-primary)', color: 'var(--nscale-text-inverse)' }">
        ...
        <div class="contrast-item">
          <div class="contrast-sample" :style="{ background: 'var(--nscale-state-error)', color: '#ffffff' }">
            <h3>Error State</h3>
