...
export function initializeBridge(app: any) {
  ...
  try {
    ...
    configureBridge({
      ...
      // FALLBACK_ENABLED: true, // Fallback-Mechanismen aktivieren - removed as it's not in BRIDGE_CONFIG
      // ERROR_TOLERANCE: "high", // Hohe Fehlertoleranz - removed as it's not in BRIDGE_CONFIG
      // MAX_RETRY_ATTEMPTS: 3, // Wiederholungsversuche bei Fehlern - removed as it's not in BRIDGE_CONFIG
    });
