...
const sortedDirs = Object.keys(results.directories)
  .sort((a, b) => results.directories[b].errorCount - results.directories[a].errorCount);
...
if (results.totalErrors > 0) {
  ...
  const lowPriorityDirs = sortedDirs
    .filter(dir => results.directories[dir].errorCount > 0 && results.directories[dir].errorCount < 10)
    .slice(0, 3);
...
console.log('   npm run typecheck:strict -- --files src/specific-directory/**/*.ts');
