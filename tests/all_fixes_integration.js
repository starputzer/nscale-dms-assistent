...
(function() {
    ...
    const fixScriptPaths = {
        textStreaming: '/tests/enhanced_text_streaming_fix.js',
        sessionHighlighting: '/tests/improved_session_highlighting_fix.js',
        adminPanel: '/tests/improved_admin_panel_fix.js',
        sessionInputPersister: '/tests/improved_session_input_persister.js',
        adminStats: '/tests/improved_admin_stats_fix.js'
    };
