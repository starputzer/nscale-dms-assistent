...
test.describe('Authentifizierungs-Flow', () => {
  ...
  test('Redirect zur Login-Seite bei nicht authentifizierten Anfragen', async ({ page }) => {
  ...
  test('Authentifizierungsstatus bleibt nach Seitenaktualisierung erhalten', async ({ page }) => {
