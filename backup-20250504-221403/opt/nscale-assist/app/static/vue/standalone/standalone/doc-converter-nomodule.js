/**
 * Dokument-Konverter NoModule Version (Standalone-Version ohne Abhängigkeiten und ohne ES6 Module)
...
(function() {
    ...
    function log(message, type) {
        type = type || 'info';
        var prefix = "[DocConverter-NoModule]";
    ...
    function findOrCreateContainer() {
        ...
        for (var i = 0; i < selectors.length; i++) {
            ...
            if (elements.length > 0) {
                ...
                log('Container gefunden mit Selektor: ' + selectors[i]);
                break;
            }
        }
        ...
        if (!container) {
            ...
            for (var j = 0; j < parentSelectors.length; j++) {
                var parentElements = document.querySelectorAll(parentSelectors[j]);
                if (parentElements.length > 0) {
                    parent = parentElements[0];
                    log('Elternelement gefunden mit Selektor: ' + parentSelectors[j]);
                    break;
                }
            }
    ...
    function createUI(container) {
        ...
        var form = container.querySelector('#converter-form');
        var progressContainer = container.querySelector('#conversion-progress');
        var progressBar = container.querySelector('.progress-bar-inner');
        var progressText = container.querySelector('.progress-text');
        var resultsContainer = container.querySelector('#conversion-results');
